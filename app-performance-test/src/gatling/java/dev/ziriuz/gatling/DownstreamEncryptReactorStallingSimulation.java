...
public class DownstreamEncryptReactorStallingSimulation extends Simulation {
...

    {
        setUp(
                actionApi.injectOpen(
                        constantUsersPerSec(100).during(Duration.ofSeconds(2)).randomized()
                )
